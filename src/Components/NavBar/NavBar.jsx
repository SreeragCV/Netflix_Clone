...
const searchMovie = (keywords) => {
    axios.get(`https://api.themoviedb.org/3/search/collection?query=${keywords}&include_adult=false&language=en-US&page=1`, options).then(res => {
  ...
  return (
    <div className='navbar'>
      ...
      <input className='input' value={movieText} onChange={handleChange} type="text" placeholder='Search...' />
      <button onClick={() => searchMovie(movieText)} className='btn'>&#x1F50E;&#xFE0E;</button>
